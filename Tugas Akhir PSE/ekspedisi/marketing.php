...
<section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h1 class="page-section-heading text-center text-uppercase text-secondary mb-0">Tambah Penjualan</h1>
                <!-- Icon Divider-->
        ...
        error_reporting(0);
            if(isset($_POST['Simpan'])){
                ...
                if($no_barang=='' || $nama_barang=='' || $berat_barang=='' || $harga=='' || $distribusi==''){
                    echo  "belum lengkap";
                }else{
                    $simpan = mysqli_query($konek,"insert into marketing(no_barang,nama_barang,berat_barang, harga, distribusi)
                        values('$no_barang','$nama_barang','$berat_barang','$harga','$distribusi')");
                    if(!$simpan){
                        echo "GAGAL SIMPAN";
                    }else{
                        $ds=mysqli_fetch_array(mysqli_query($konek,"SELECT no_barang FROM marketing ORDER BY no_barang DESC
                            LIMIT 1"));
                        $no_barang = $ds['nomer_barang'];
                        }
                    }
                }
