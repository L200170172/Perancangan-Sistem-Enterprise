...
<section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h1 class="page-section-heading text-center text-uppercase text-secondary mb-0">Ubah Pengiriman</h1>
                <!-- Icon Divider-->
 ...
 <?php 
 error_reporting(0);
    $sqlEdit=mysqli_query($konek, "SELECT * FROM sales WHERE nip='$nip'");
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if($nip=='' || $nama=='' ||  $telp=='' || $no_barang=='' || $nama_barang==''){
            ...
            $update = mysqli_query($konek,"UPDATE sales SET 
                                                nip='$nip',
                                                nama_pegawai='$nama',
                                                telp_pegawai='$telp',
                                                no_barang='$no_barang',
