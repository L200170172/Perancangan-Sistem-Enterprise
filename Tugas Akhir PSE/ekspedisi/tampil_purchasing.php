...
<a href="purchasing.php" class="btn btn-primary btn-icon-split">
...
<div class="container">
  <div class="table-responsive">
    <table class="table" id="dataTable" width="100%" cellspacing="0">
      ...
      <?php
      error_reporting(0);
      $sql = mysqli_query($konek, "SELECT * FROM purchasing order by kode_barang");
      $no=1;
      while($d=mysqli_fetch_array($sql)){
        echo "<tr>
              ...
              <td> 
              <a href='hapus_purchasing.php?id=$d[kode_barang]' class='btn btn-danger btn-circle'>
